...
export const ROADMAP: Phase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Roles and per-operator permissions, managed in the product', done: true },
      { text: 'A master account no operator can edit, disable or demote', done: true },
      { text: 'Master transferable, demoting the holder in the same step', done: true },
      { text: 'Accounts removable with their recordings kept or destroyed', done: true },
      { text: 'Status page behind operator access', done: true },
